                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="text" name="base_price" id="base_price"
                                                                ...
                                                                @if (isset($products)) value="{{ $products->base_price }}" @endisset autocomplete="off" required
                                                    {{ $disabled_ }} style="width:100%;">
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                                                ...
                                                                <div class="col-md-5">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <select class="form-control selectpicker"
                                                                            ...
                                                                            data-size="8" data-show-subtext="true"
                                                ...
                                                @if ($products->upload != null)
                                                    ...
                                                    <a href="{{ url('/') . '/Uploads/Product/' . $products->upload }}"
                                                        target="_blank"><i class="fa fa-download"
                                                            aria-hidden="true"></i> &nbsp;<?php echo $changename; ?> </a><br>
                                                @else
                                                    <span style="font-size: 13px;color: red">*) .png .jpg .jpeg</span>
                                                @endif
                                            @endif
