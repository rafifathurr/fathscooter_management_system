            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-10">
                    <div class="wrap d-md-flex">
                        <div class="img"
                            style="background-image: url(../img/bg-1.png);background-size: contain;margin: 10px;">
                        </div>
                            ...
                            <form action="{{ route('forgot.updatepass') }}" method="post">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="email" name="email" id="email" placeholder="Email"
                                        class="form-control" placeholder="Your Email Address" autofocus required
                                        value="{{ old('email') }}">
                                </div>
                                <div class="form-group mb-3">
								...
								<span class="checkmark"></span>
                                    ...
                                    <div class="w-50 text-md-right">
                                        <a href="{{ url('/') }}"><i>Back To Sign In </i> </a>
                                    </div>
                                </div>
                            </form>
                        </div>
