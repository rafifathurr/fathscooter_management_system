                    ...
                    <div class="d-flex">
                        @if (Auth::guard('admin')->check())
                            <button id="export" class="btn btn-primary btn-round ml-auto mb-3"
                                style="background-color:green !important; margin-right: 10px;"
                                @if (count($years) == 0) disabled @endif>
                        ...
                        <div id="add-row_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    @else
                                        <table id="add-row"
                                            class="display table table-striped table-hover dataTable" cellspacing="0"
