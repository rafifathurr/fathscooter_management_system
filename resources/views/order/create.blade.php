...
<body>
                        ...
                        <div class="box box-primary">
                            <div class="box-body create">
                                ...
                                @endif
                                    {{ csrf_field() }}
                                    <br>
                                    <input type="hidden" name="invoice" id="invoice" class="form-control" autocomplete="off" value="{{$type}}" required {{$disabled_}}>
                                    <div class="row">
                                        <div class="col-md-5">
                                            <label class="col-md-6">No Invoice <span style="color: red;">*</span></label>
                                            <div class="col-md-12">                          
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label class="col-md-5">Entry Price <span style="color: red;">*</span></label>
                                            <div class="col-md-12">    
                                        ...
                                        <div class="col-md-4">
                                            <label class="col-md-5">Total Profit  <span style="color: red;">*</span></label>
                                            <div class="col-md-12">                          
                                        ...
                                        <div class="col-md-4">
                                            <label class="col-md-5">Platform Fee <span style="color: red;">*</span></label>
                                            <div class="col-md-12">                          
                                    ...
                                    <div class="row">
                                        <div class="col-md-12" >
                                            <div style="float: right; margin-right:20px;">
                                                <a href="#collapse" class="btn btn-primary" id="btn-collapse"><i class="fa fa-plus"></i> Add Product</a>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                            ...
                                            <div id="collapse" class="panel-collapse collapse">
                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <label class="col-md-5">Selling Price <span style="color: red;">*</span></label>
                                                            <div class="col-md-12">                          
    ...
    <script>
        ...
        function sell_price_update(e, id){
            var qty = $("#qty_"+id).val();
            var max_stock = $("#max_stock_"+id).val();
            var sell_price_table = $("#sell_price_"+id).val();

            console.log("max length stock : "+id);
            // console.log("QTY : "+qty+" MAX STOCK : "+max_stock+" SELL PRICE : "+sell_price);
        ...
        $(document).ready(function() {
            ...
            $('#btn_tambahToTable').on('click', function() {
                ...
                if(product != ''){
                    ...
                    console.log("index saat ini"+i);

                    $('#table_body').append("<tr id='"+(i+1)+"'>"+
                    "<td><center><input type='hidden' name='product_id[]' value='"+productData.id+"' readonly>"+productData.product_name+"</center></td>"+
                    "<input type='hidden' name='max_stock[]' value='"+max_stock+"' id='max_stock_"+i+"' readonly>"+
                    "<td><center><input type='number' style='width:100px !important; height:25px !important; text-align:center;' class='form-control' name='qty[]' id='qty_"+i+"' value='"+qty+"' onkeyup ='sell_price_update(this,"+i+")'></center></td>"+
                    "<td><center><input type='text' style='width:100px !important; height:25px !important; text-align:center;' class='form-control numeric' name='sell_price[]' id='sell_price_"+i+"' value='"+sell+"' disabled></center></td>"+
