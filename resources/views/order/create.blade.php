                            ...
                            <div class="box box-primary">
                                <div class="box-body">
                                    <form id="form_add" action="{{ route('admin.order.' . $url) }}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label class="col-md-12">No Invoice <span
                                                        style="color: red;">*</span></label>
                                                <div class="col-md-12">
                                                    <input type="text" name="invoice" id="invoice"
                                                        class="form-control" placeholder="No Invoice Order"
                                                        @if (isset($orders)) value="{{ $orders->invoice }}" @endisset autocomplete="off" required {{ $disabled_ }}>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                                                ...
                                                                @if ($title == 'Add Order' || $title == 'Edit Order')
                                                                    <div class="panel-body">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                <label class="col-md-12">Base Price
                                                                                    <span
                                                                                        style="color: red;">*</span></label>
                                                                                <div class="col-md-12">
                                                                                    <input type="hidden"
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                <label class="col-md-12">Selling Price
                                                                                    <span
                                                                                        style="color: red;">*</span></label>
                                                                                <div class="col-md-12">
                                                                                    <input type="hidden"
                                                                        ...
                                                                        @isset($orders)
                                                                            @foreach ($details_order as $details)
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="text-align:right;">
                                                                                        Rp.
                                                                                        {{ number_format($details->qty * $details->base_price_save, 0, ',', '.') }}
                                                                                    </td>
                                                                                    <td style="text-align:right;">
                                                                                        Rp.
                                                                                        {{ number_format($details->qty * $details->selling_price_save, 0, ',', '.') }}
                                                                                    </td>
                                                                                </tr>
                                                                            @endforeach
                                                                        @endisset
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <input type="text"
                                                                                    class="form-control numeric"
                                                                                    @if (isset($orders)) value="{{ $orders->total_base_price }}" @endisset style='width:100px !important; height:25px !important; text-align:center;' name="base_price" id="total_base_price" readonly>
                                                            </td>
                                                            <td>
                                                ...
                                                <a style="color:white;" class="btn btn-primary" id="btn-collapse"><i class="fa fa-plus"></i> Add Product</a>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            @if ($title == 'Add Order' || $title == 'Edit Order')
                                                            <td><button type='button' class='btn btn-link' onclick="removedata()"><i style="color:black; font-weight:bold;" class="icon-refresh"></i></button></td> @endif
                                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                                                @if (isset($orders))
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <label class="col-md-2"> <i><b>Created
                                                                                        By</b></i> </label>
                                                                            <div class="col-md-2">
                                                                                <label
                        ...
                        if (id_product != "") {
                            ...
                            if (data.length > 0 && length > 0) {
                                ...
                                $('#table_body').append("<tr id='" + id_product + "'>" +
                                    ...
                                    "' readonly><span id='product_name_" + id_product + "'>" + product_name +
                                    "</span></td>" +
                                    "<input type='hidden' name='max_stock[]' value='" + max_stock +
                                    "' id='max_stock_" + id_product + "' readonly>" +
                                    "<td><center><input type='number' style='width:100px !important; height:25px !important; text-align:center;' min=0 max='" +
                                    max_stock + "' class='form-control' name='qty[]' id='qty_" + id_product +
                                    "' value='" + qty + "' oninput ='price_update(" + id_product +
                                    ")'></center></td>" +
                                    "<input type='hidden' name='base_price_data[]' id='base_price_data_" +
                                    id_product + "' value='" + base_price + "'>" +
                                    "<td><center><input type='text' style='width:100px !important; height:25px !important; text-align:center;' class='form-control numeric' name='base_price_arr[]' id='base_price_" +
                                    id_product + "' value='" + base + "' readonly></center></td>" +
                                    "<input type='hidden' name='sell_price_data[]' id='sell_price_data_" +
                                    id_product + "' value='" + sell_price + "'>" +
                                    "<td><center><input type='text' style='width:100px !important; height:25px !important; text-align:center;' class='form-control numeric' name='sell_price_arr[]' id='sell_price_" +
                                    id_product + "' value='" + sell + "' readonly></center></td>" +
                        ...
                        if (id_product != "") {
                            ...
                            if (data.length > 0 && length > 0) {
                                ...
                                $('#table_body').append("<tr id='" + id_product + "'>" +
                                    ...
                                    "<input type='hidden' name='base_price_data[]' id='base_price_data_" +
                                    id_product + "' value='" + base_price + "'>" +
                                    "<input type='hidden' style='width:100px !important; height:25px !important; text-align:center;' class='form-control numeric' name='base_price_arr[]' id='base_price_" +
                                    id_product + "' value='" + base + "' readonly>" +
                                    "<input type='hidden' name='sell_price_data[]' id='sell_price_data_" +
                                    id_product + "' value='" + sell_price + "'>" +
                                    "<td><center><input type='text' style='width:100px !important; height:25px !important; text-align:center;' class='form-control numeric' name='sell_price_arr[]' id='sell_price_" +
                                    id_product + "' value='" + sell + "' readonly></center></td>" +
