    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            <div class="content">
                ...
                <form id="form_add" action="{{ route('admin.analysis.' . $url) }}" method="POST"
                        ...
                        <div class="content container-fluid">
                            <div class="box box-primary">
                                <div class="box-body">
                                    ...
                                    <input type="hidden" name="id_analysis"
                                        @isset($analysis) value="{{ $analysis->id }}" @endisset>
                                    {{-- <input type="hidden" name="month" @isset($month) value="{{ $month }}" @endisset> --}}
                                    <input type="hidden" name="year"
                                        @isset($year) value="{{ $year }}" @endisset>
                                    {{ csrf_field() }}
                                    <br>
                                    <table @if ($title == 'Detail Analysis') id="add-row" @endif
                                                ...
                                                @foreach ($details as $key => $detail)
                                                    <tr id='{{ $detail->id_product }}'>
                                                        ...
                                                        <td style="text-align:center;">
                                                            <input type="hidden" id="demandpermonth_data"
                                                                @isset($detail->demandpermonth) value="{{ $detail->demandpermonth }}" @else value="{{ $detail->demand }}" @endisset
                                                                readonly required>
                                                            <input type="number" class='form-control numeric'
                                                                name="demandpermonth[]"
                                                                @isset($detail->demandpermonth) value="{{ $detail->demandpermonth }}" @else value="{{ $detail->demand }}" @endisset
                                                                id="demandpermonth_{{ $detail->id_product }}" readonly
                                                                required>
                                                        </td>
                                                        <td style="text-align:center;">
                                                            <input type="hidden" id="setupcost_data"
                                                                value="{{ $detail->setupcost }}">
                                                            <input type="text" class='form-control numeric'
                                                                name="setupcost[]"
                                                                id="setupcost_{{ $detail->id_product }}"
                                                                value="{{ number_format((float) $detail->setupcost, 0, '.', '') }}"
                                                                readonly required>
                                                        </td>
                                                        <td style="text-align:center;">
                                                            <input type="text" class='form-control numeric' min=0
                                                                @isset($detail->holdingcost) value="{{ $detail->holdingcost }}" @endisset
                                                                name="holdingcost[]"
                                                                id="holdingcost_{{ $detail->id_product }}"
                                                                oninput="calculate_eoq({{ $detail->id_product }})"
                                                                required>
                                                        </td>
                                                        <td style="text-align:center;">
                                                            <input type="number" class='form-control numeric'
                                                                name="eoq[]"
                                                                @isset($detail->eoq_value) value="{{ $detail->eoq_value }}" @endisset
                                                                id="eoq_{{ $detail->id_product }}" readonly required>
                                                        </td>
                                                        <td>
                                                            <center>
                                                                <button type='button'
                                                                    class='btn btn-link btn-simple-danger'
                                                                    onclick="reset_data({{ $detail->id_product }}, 1)"
                                                                    title='Reset'>
                        ...
                        <div class="content container-fluid">
                            <div class="box box-primary">
                                <div class="box-body">
                                    ...
                                    {{ csrf_field() }}
                                    <br>
                                    <table @if ($title == 'Detail Analysis') id="add-row-2" @endif
                                        class="table table-striped table-bordered table-hover" width="100%"
                                            ...
                                            @if ($title == 'Edit Analysis' || $title == 'Add Analysis')
                                                @foreach ($details as $key => $detail)
                                                    <tr id='{{ $detail->id_product }}'>
                                                        ...
                                                        <td style="text-align:center;">
                                                            <input type="hidden" id="max_sales_data"
                                                                value="{{ round($details_2[$key]->max_sales, 0) }}"
                                                                readonly required>
                                                            <input type="number" class='form-control numeric'
                                                                name="max_sales[]"
                                                                value="{{ round($details_2[$key]->max_sales, 0) }}"
                                                                id="max_sales_{{ $detail->id_product }}" readonly
                                                                required>
                                                        </td>
                                                        <td style="text-align:center;">
                                                            <input type="hidden" id="avg_sales_data"
                                                                value="{{ round($details_2[$key]->avg_sales, 0) }}"
                                                                readonly required>
                                                            <input type="number" class='form-control numeric'
                                                                name="avg_sales[]"
                                                                value="{{ round($details_2[$key]->avg_sales, 0) }}"
                                                                id="avg_sales_{{ $detail->id_product }}" readonly
                                                                required>
                                                        </td>
                                                        <td style="text-align:center;">
                                                            <input type="number" class='form-control numeric'
                                                                min='0' name="max_lead_time[]"
                                                                oninput="calculate_safety_stock({{ $detail->id_product }}, 2)"
                                                                @isset($details_2[$key]->max_lead_time) value="{{ $details_2[$key]->max_lead_time }}" @endisset
                                                                id="max_lead_time_{{ $detail->id_product }}" required>
                                                        </td>
                                                        <td style="text-align:center;">
                                                            <input type="number" class='form-control numeric'
                                                                min='0' name="avg_lead_time[]"
                                                                oninput="calculate_safety_stock({{ $detail->id_product }}, 2)"
                                                                @isset($details_2[$key]->avg_lead_time) value="{{ $details_2[$key]->avg_lead_time }}" @endisset
                                                                id="avg_lead_time_{{ $detail->id_product }}" required>
                                                        </td>
                                                        <td style="text-align:center;">
                                                            <input type="hidden" class='form-control'
                                                                name="demandpermonthdatas[]"
                                                                @isset($detail->demandpermonth) value="{{ $detail->demandpermonth }}" @else value="{{ $detail->demand }}" @endisset
                                                                id="demandpermonthdata_{{ $detail->id_product }}">
                                                            <input type="number" class='form-control numeric'
                                                                name="safety_stock[]"
                                                                @isset($details_2[$key]->safety_stock) value="{{ $details_2[$key]->safety_stock }}" @endisset
                                                                id="safety_stock_{{ $detail->id_product }}" required
                                                                readonly>
                                                        </td>
                                                        <td style="text-align:center;">
                                                            <input type="number" class='form-control numeric'
                                                                name="rop[]"
                                                                @isset($details_2[$key]->rop) value="{{ $details_2[$key]->rop }}" @endisset
                                                                id="rop_{{ $detail->id_product }}" required readonly>
                                                        </td>
                                                        <td>
                                                            <center>
                                                                <button type='button'
                                                                    class='btn btn-link btn-simple-danger'
                                                                    onclick="reset_data({{ $detail->id_product }}, 2)"
                                                                    title='Reset'>
                                                                    <i style="color:black; font-weight:bold;"
                                                                        class="icon-refresh"></i>
                                                                </button>
                        ...
                        <div style="float:right;">
                            @if ($title == 'Add Analysis')
                                <div class="col-md-10" style="margin-right: 20px;">
                                    <a href="{{ route('admin.analysis.index') }}" type="button"
