                ...
                <div class="content">
                    ...
                    <div class="content container-fluid">
                        <div class="box box-primary">
                            <div class="box-body">
                                <form id="form_add" @if (Auth::guard('admin')->check()) action="{{ route('admin.product.' . $url) }}" @else action="{{ route('user.product.' . $url) }}" @endif method="post"
                                        ...
                                        <div class="col-md-10" style="display:block !important  ">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="name" id="name " class="form-control"
                                                    step="1"
                                                    @if (isset($products)) value="{{ $products->product_name }}" @endisset autocomplete="off" required
                                    ...
                                    @if (Auth::guard('admin')->check())
                                        <div class="row">
                                            <div class="col-md-1"></div>
                                            <div class="col-md-5">
                                                <label class="col-md-12">Base Price <span
                                                        style="color: red;">*</span></label>
                                                <div class="col-md-12">
                                                    <input type="text" name="base_price" id="base_price"
                                                        class="form-control numeric" step="1"
                                                        @if (isset($products)) value="{{ $products->base_price }}" @endisset autocomplete="off" required {{ $disabled_ }} style="width:100%;">
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <label class="col-md-12">Selling Price <span style="color: red;">*</span></label>
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="col-md-12">
                                                <select class="form-control selectpicker"
                                                    ...
                                                    @if (isset($products)) @endisset autocomplete="off" required {{ $disabled_ }}>
                                            ...
                                            <div class="col-md-12">
                                                <select class="form-control selectpicker" id="supplier"
                                                    ...
                                                    @foreach ($suppliers as $sup)
                                                        <option  @if (isset($products)) <?php if ($products->supplier_id == $sup->id) {
                                                            echo 'selected';
                                                        } ?> @endisset value="{{ $sup->id }}">{{ $sup->supplier }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                                ...
                                                @if ($title == 'Add Products' || $title == 'Edit Products')
                                                    ...
                                                    @if (isset($products))
                                                        @if ($products->upload != null)
                                                            ...
                                                            ?>
                                                            <a href="{{ url('/') . '/Uploads/Product/' . $products->upload }}" target="_blank">
                                                    ...
                                                    @else
                                                        <span
                                                            style="font-size: 13px;color: red">*) .png
                                                            .jpg .jpeg</span>
                                                    @endif
                                                @else
                                                    @if (isset($products))
                                                        @if ($products->upload != null)
                                                            ...
                                                            <a href="{{ url('/') . '/Uploads/Product/' . $products->upload }}"
                                                                target="_blank"><i class="fa fa-download"
                                                                    aria-hidden="true"></i> &nbsp;{{ $changename }} </a><br>
                                                        @else
                                                            <span style="font-size: 13px;color: red">*) .png .jpg .jpeg</span>
                                                        @endif
                                                    @endif
                                    ...
                                    @if (isset($products))
                                        <div class="row">
                                            ...
                                            <div class="col-md-11">
                                                ...
                                                <div class="col-md-12">
                                                    <label
                                                        for=""><i><b>{{ $products->createdby->name }}</b></i></label>
                                                </div>
                                                <div class="col-md-12">
                                                    <label
                                                        for=""><i><b>{{ date('l, j F Y  h:i A', strtotime($products->created_at)) }}</b></i></label>
                                                </div>
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
                                            ...
                                            <div class="col-md-11">
                                                ...
                                                @if ($products->updated_by != null)
                                                    <div class="col-md-12">
                                                        <label
                                                            for=""><i><b>{{ $products->updatedby->name }}</b></i></label>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <label
                                                            for=""><i><b>{{ date('l, j F Y  h:i A', strtotime($products->updated_at)) }}</b></i></label>
                                                    </div>
                                                @else
                                                    <div class="col-md-2">
